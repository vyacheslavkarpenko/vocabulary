class TranslatesController < ApplicationController
  ...
  def index
    page = params[:page] || 1
    @translates = Translate.page(page).per(15)
  end

  def not_learned
    page = params[:page] || 1
    @translates = Translate.where(learned: false).page(page).per(15)
  end

  def for_repeat
    page = params[:page] || 1
    @translates = Translate.where(learned: true).page(page).per(15)
  end
  # GET /translates/1
